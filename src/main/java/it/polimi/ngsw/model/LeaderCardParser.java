...
public class LeaderCardParser {
    ...
    public void initSpaceLeaderCards() throws FileNotFoundException {
        ...
        FileReader reader = new FileReader("src/main/java/it/polimi/resources/SpaceAbility.json");
    ...
    public void initDiscountLeaderCards() throws FileNotFoundException {
        ...
        Gson customGson = gsonBuilder.create();
        FileReader reader = new FileReader("src/main/java/it/polimi/resources/DiscountAbility.json");
    ...
    public void initWhiteMarbleLeaderCards() throws FileNotFoundException {
        ...
        Gson customGson = gsonBuilder.create();
        FileReader reader = new FileReader("src/main/java/it/polimi/resources/WhiteMarbleAbility.json");
    ...
    public void initProductionPowerLeaderCards() throws FileNotFoundException {
        ...
        Gson customGson = gsonBuilder.create();
        FileReader reader = new FileReader("src/main/java/it/polimi/resources/ProductionPowerAbility.json");
